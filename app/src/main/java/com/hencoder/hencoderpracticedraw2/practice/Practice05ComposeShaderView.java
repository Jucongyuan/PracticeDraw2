...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader batmanShader = new BitmapShader(batman, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
        Shader batman_logoShader = new BitmapShader(batman_logo, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);

        ComposeShader composeShader = new ComposeShader(batmanShader, batman_logoShader, PorterDuff.Mode.DST_IN);
