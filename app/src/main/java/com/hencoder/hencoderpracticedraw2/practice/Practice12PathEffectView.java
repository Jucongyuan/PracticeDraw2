...
public class Practice12PathEffectView extends View {
...

    {
        ...
        cornerPathEffect = new CornerPathEffect(100);
        discretePathEffect = new DiscretePathEffect(20, 5);
        dashPathEffect = new DashPathEffect(new float[]{20, 5, 10, 5}, 0);

        pathAngle.moveTo(0, 20);
        pathAngle.rLineTo(15, -20);
        pathAngle.rLineTo(20, 15);
        pathAngle.close();

        pathDashPathEffect = new PathDashPathEffect(pathAngle, 40, 0, PathDashPathEffect.Style.MORPH);
